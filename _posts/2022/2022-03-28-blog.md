...
技术博客，可以作为自己技术输出的一种方式，相对三方技术论坛，自己的技术博客更有自主性和归属感。看过很多搭建技术博客的帖子，网上也用过很多开源的框架，个人觉得比较理想的是GitHub Pages+Jekyll，因此今天就分享一下如何用这两个组合搭建自己免费的技术博客。
...
![img.png](../../assets/md/blog/rename.png)
   
4. 设置Github Pages
如下图操作，点击Settings按钮进入，左边找到Pages，然后设置分支等信息，点击保存后会出现一条提示
![img.png](../../assets/md/blog/set.png)

5. 访问步骤4中生成的地址

浏览器地址栏中输入：https://yuanjavar.github.io/yuanjava.github.io/ ，如下图，因为样式原因，显示有些问题
![img.png](../../assets/md/blog/page.png)
...
![img.png](../../assets/md/blog/img.png)
...
![img.png](../../assets/md/blog/domain.png)
